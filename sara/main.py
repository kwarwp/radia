...
PEAO = 'https://w1.pngwing.com/pngs/856/1022/png-transparent-beyblade-spinning-tops-drawing-toy-trompo-spin-top-fighter-beyblade-revolution-spinning-tops-battle.png'
...
class IlhaProibida:
    def __init__(self):
        ...
        peao = Elemento(PEAO, x=20, y=50, w=40, h=40, tit='Palácio de Coral', cena=oceano)
